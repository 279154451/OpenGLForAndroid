...
import com.qi.tai.opengl.base.render.GlRender;
...
public class GLTextureView extends TextureView
        implements TextureView.SurfaceTextureListener, View.OnLayoutChangeListener, GLView {
     ...
     */
    public void setRenderer(GlRender renderer) {
     ...
     * <p>If this method is
     * called, it must be called before {@link #setRenderer(GlRender)}
     * is called.
     * <p>
     ...
     * <p>If this method is called, it must be called before {@link #setRenderer(GlRender)}
     * is called.
     ...
     * <p>
     * This method can only be called after {@link #setRenderer(GlRender)}
     *

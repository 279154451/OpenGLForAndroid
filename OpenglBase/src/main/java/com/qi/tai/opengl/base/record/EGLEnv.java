...
public class EGLEnv {
    ...
    private final VideoRecordProgram recordProgram;
    private  EGLDisplay mEglDisplay;

    public EGLEnv( EGLContext mGlContext, Surface surface, int width, int height) {
       ...
       if (!EGL14.eglMakeCurrent(mEglDisplay,mEglSurface,mEglSurface,mEglContext)){
        ...
        recordProgram = new VideoRecordProgram();
        recordProgram.surfaceChange(width,height);
    }

    public void onDraw(int textureId,float[] mtx, long timestamp) {
        recordProgram.onDraw(textureId,mtx);
